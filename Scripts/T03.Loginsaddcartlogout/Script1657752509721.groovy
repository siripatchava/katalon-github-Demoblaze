...
WebUI.doubleClick(findTestObject('Page_STORE/input_Username_loginusername'))

WebUI.setText(findTestObject('Page_STORE/input_Username_loginusername'), 'sirishapatchava@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_STORE/input_Password_loginpassword'), 'TeqQ1KSF8Ly3q7iVypQNgw==')
